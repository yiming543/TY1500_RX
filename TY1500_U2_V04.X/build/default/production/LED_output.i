...
void DRL_ON(void) { LATAbits.LATA2 = 1; }

void DRL_OFF(void) { LATAbits.LATA2 = 0; }

void POS_ON(void) { LATAbits.LATA1 = 1; }

void POS_OFF(void) { LATAbits.LATA1 = 0; }

void FAN_ON(void) { LATBbits.LATB5 = 1; }

void FAN_OFF(void) { LATBbits.LATB5 = 0; }

void LOBEAM_ON(void) { LATBbits.LATB4 = 1; }

void LOBEAM_OFF(void) { LATBbits.LATB4 = 0; }

void HIBEAM_ON(void) { LATBbits.LATB3 = 1; }
void HIBEAM_OFF(void) { LATBbits.LATB3 = 0; }

void WELCOME_ON(void) { LATAbits.LATA4 = 1; }
void WELCOME_OFF(void) { LATAbits.LATA4 = 0; }
